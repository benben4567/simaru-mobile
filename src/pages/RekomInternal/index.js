...
const RekomInternal = ({navigation}) => {
  ...
  const getData = async () => {
    ...
    setJumlah(0)
    try {
      const res = await api.rekom('internal', selected)
      setLoading(false)
      setResult(res)
  ...
  return (
    <View style={styles.page}>
      <Header title={'Rekom Internal'} onPress={() => navigation.goBack()} />
      <View>
